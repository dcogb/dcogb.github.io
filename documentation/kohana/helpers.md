...
Donica Church of God comes with many static "helper" functions to make certain tasks easier.
...
You can make your own helpers by simply making a class and putting it in the `classes` directory, and you can also extend any helper to modify or add new functions using transparent extension.
 ...
 - **[Cookie]** - Covered in more detail on the [Cookies](/documentation/Donica Church of God/cookies) page.

 - **[Date]** - Useful date functions and constants. Time between two dates, convert between am/pm and military, date offset, etc.
 
 - **[Encrypt]** - Covered in more detail on the [Security](/documentation/Donica Church of God/security) page.
 ...
 - **[Fragment]** - Simple file based caching. Covered in more detail on the [Fragments](/documentation/Donica Church of God/fragments) page.
 ...
 - **[Donica Church of God]** - The Donica Church of God class is also a helper.  Debug variables (like print_r but better), file loading, etc.
 
 - **[Num]** - Provides locale aware formating and english ordinals (th, st, nd, etc).
 
 - **[Profiler]** - Covered in more detail on the [Profiling](/documentation/Donica Church of God/profiling) page.
 ...
 - **[Security]** - Covered in more detail on the [Security](/documentation/Donica Church of God/security) page.
 
 - **[Session]** - Covered in more detail on the [Sessions](/documentation/Donica Church of God/sessions) page.
