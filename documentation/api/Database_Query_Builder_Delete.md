...
extends <a href='/documentation/api/Kohana_Database_Query_Builder_Delete'>Kohana_Database_Query_Builder_Delete</a>
<br />
...
<p>This class is a transparent base class for <a href='/documentation/api/Kohana_Database_Query_Builder_Delete'>Kohana_Database_Query_Builder_Delete</a></p>
</div>
</div>
...
<div class='method'>
<h3 id="__construct"><small>public</small>  __construct([ <small>mixed</small> <span class="param" title="Table name or array($table, $alias) or object">$table</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Kohana_Database_Query_Builder_Delete'>Kohana_Database_Query_Builder_Delete</a>)</small></h3>
...
<div class='method'>
<h3 id="compile"><small>public</small>  compile([ <small>mixed</small> <span class="param" title="Database instance or name of instance">$db</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Kohana_Database_Query_Builder_Delete'>Kohana_Database_Query_Builder_Delete</a>)</small></h3>
...
<div class='method'>
<h3 id="reset"><small>public</small>  reset()<small> (defined in <a href='/documentation/api/Kohana_Database_Query_Builder_Delete'>Kohana_Database_Query_Builder_Delete</a>)</small></h3>
...
<div class='method'>
<h3 id="table"><small>public</small>  table(<small>mixed</small> <span class="param" title="Table name or array($table, $alias) or object">$table</span> )<small> (defined in <a href='/documentation/api/Kohana_Database_Query_Builder_Delete'>Kohana_Database_Query_Builder_Delete</a>)</small></h3>
