---
layout: api
class: Model_User_Token
---
<h1>Model_User_Token</h1>
extends <a href='/documentation/api/Model_Auth_User_Token'>Model_Auth_User_Token</a>
<br />
...
<li>
<a href="#delete_expired">delete_expired()</a>
</li>
<li>
...
<li>
<a href="#create_token">create_token()</a>
</li>
<li>
...
<dt>
<h4 id='property-_belongs_to'><small>protected</small>  <span class='blue'></span> $_belongs_to</h4>
</dt>
<dd>
 </dd>
<dd>
...
<dd>
 <pre class="debug"><small>array</small><span>(0)</span> </pre></dd>
<dt>
<h4 id='property-_created_column'><small>protected</small>  <span class='blue'></span> $_created_column</h4>
</dt>
<dd>
 </dd>
<dd>
...
<br />
 <pre class="debug"><small>array</small><span>(2)</span> <span>(
    "column" => <small>string</small><span>(7)</span> "created"
    "format" => <small>bool</small> TRUE
)</span></pre></dd>
<dt>
...
<div class='method'>
<h3 id="__construct"><small>public</small>  __construct()<small> (defined in <a href='/documentation/api/Model_Auth_User_Token'>Model_Auth_User_Token</a>)</small></h3>
<div class='description'><p>Handles garbage collection and deleting of expired objects.</p>
</div>
<h4>Return Values</h4>
<ul class='return'>
<li>
...
<div class='method'>
<h3 id="create"><small>public</small>  create([ <small>Validation</small> <span class="param" title="Validation object">$validation</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Model_Auth_User_Token'>Model_Auth_User_Token</a>)</small></h3>
...
<div class='method'>
<h3 id="delete_expired"><small>public</small>  delete_expired()<small> (defined in <a href='/documentation/api/Model_Auth_User_Token'>Model_Auth_User_Token</a>)</small></h3>
<div class='description'><p>Deletes all expired tokens.</p>
</div>
<h4>Return Values</h4>
<ul class='return'>
<li>
...
<h4>Source Code</h4>
<pre>
<code class="language-php">public function delete_expired()
{
...
<div class='method'>
<h3 id="filters"><small>public</small>  filters()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_ORM'>Mountain Valley Church of God_ORM</a>)</small></h3>
...
<div class='method'>
<h3 id="labels"><small>public</small>  labels()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_ORM'>Mountain Valley Church of God_ORM</a>)</small></h3>
...
<div class='method'>
<h3 id="rules"><small>public</small>  rules()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_ORM'>Mountain Valley Church of God_ORM</a>)</small></h3>
...
<div class='method'>
<h3 id="create_token"><small>protected</small>  create_token()<small> (defined in <a href='/documentation/api/Model_Auth_User_Token'>Model_Auth_User_Token</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">protected function create_token()
{
	do
	{
