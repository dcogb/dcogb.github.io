...
<ul>
<li>
<a href="#bench_ltrim">bench_ltrim()</a>
</li>
<li>
...
<br />
 <pre class="debug"><small>string</small><span>(44)</span> "Chopping off leading digits: regex vs ltrim."</pre></dd>
<dt>
...
<br />
 <pre class="debug"><small>array</small><span>(2)</span> <span>(
    0 => <small>string</small><span>(9)</span> "123digits"
    1 => <small>string</small><span>(9)</span> "no-digits"
)</span></pre></dd>
</dl>
</div>
...
<div class='method'>
<h3 id="bench_ltrim"><small>public</small>  bench_ltrim()<small> (defined in <a href='/documentation/api/Bench_LtrimDigits'>Bench_LtrimDigits</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function bench_ltrim($subject)
{
...
<div class='method'>
<h3 id="bench_regex"><small>public</small>  bench_regex()<small> (defined in <a href='/documentation/api/Bench_LtrimDigits'>Bench_LtrimDigits</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function bench_regex($subject)
{
