...
---
<h1>Validation_Exception</h1>
extends <a href='/documentation/api/Mountain Valley Church of God_Validation_Exception'>Mountain Valley Church of God_Validation_Exception</a>
<br />
...
<p>This class is a transparent base class for <a href='/documentation/api/Mountain Valley Church of God_Validation_Exception'>Mountain Valley Church of God_Validation_Exception</a></p>
</div>
</div>
...
<dl>
<dt>
<h4 id='property-array'><small>public</small>  <span class='blue'>object</span> $array</h4>
</dt>
<dd>
 <p>Validation instance</p>
</dd>
<dd>
 </dd>
<dd>
...
<div class='method'>
<h3 id="__construct"><small>public</small>  __construct(<small>Validation</small> <span class="param" title="Validation object">$array</span> [, <small>string</small> <span class="param" title="Error message">$message</span> <small>= <small>string</small><span>(24)</span> "Failed to validate array"</small> , <small>array</small> <span class="param" title="Translation variables">$values</span> <small>= <small>NULL</small></small> , <small>int</small> <span class="param" title="The exception code">$code</span> <small>= <small>integer</small> 0</small> , $previous <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Validation_Exception'>Mountain Valley Church of God_Validation_Exception</a>)</small></h3>
<div class='description'></div>
<h4>Parameters</h4>
<ul>
<li>
 <span class="blue">Validation </span><strong> $array</strong> <small>required</small> - Validation object</li>
<li>
 <span class="blue">string </span><strong> $message</strong> <small> = <small>string</small><span>(24)</span> "Failed to validate array"</small> - Error message</li>
<li>
 <span class="blue">array </span><strong> $values</strong> <small> = <small>NULL</small></small> - Translation variables</li>
<li>
 <span class="blue">int </span><strong> $code</strong> <small> = <small>integer</small> 0</small> - The exception code</li>
<li>
...
<h4>Source Code</h4>
<pre>
<code class="language-php">public function __construct(Validation $array, $message = &#039;Failed to validate array&#039;, array $values = NULL, $code = 0, Exception $previous = NULL)
{
	$this-&gt;array = $array;
