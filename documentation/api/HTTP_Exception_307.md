---
layout: api
class: HTTP_Exception_307
---
<h1>HTTP_Exception_307</h1>
extends <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_307'>Mountain Valley Church of God_HTTP_Exception_307</a>
<br />
extends <a href='/documentation/api/HTTP_Exception_Redirect'>HTTP_Exception_Redirect</a>
<br />
extends <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_Redirect'>Mountain Valley Church of God_HTTP_Exception_Redirect</a>
<br />
...
<p>This class is a transparent base class for <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_307'>Mountain Valley Church of God_HTTP_Exception_307</a></p>
</div>
</div>
...
<dd>
 <p>HTTP 307 Temporary Redirect</p>
</dd>
<dd>
 </dd>
<dd>
...
<br />
 <pre class="debug"><small>integer</small> 307</pre></dd>
<dt>
...
<div class='method'>
<h3 id="check"><small>public</small>  check()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_Redirect'>Mountain Valley Church of God_HTTP_Exception_Redirect</a>)</small></h3>
...
<div class='method'>
<h3 id="location"><small>public</small>  location([ <small>string</small> <span class="param" title="$location URI of the proxy">$uri</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_Redirect'>Mountain Valley Church of God_HTTP_Exception_Redirect</a>)</small></h3>
...
<code class="language-php">public function location($uri = NULL)
{
	...
	if (strpos($uri, &#039;://&#039;) === FALSE)
	{
		...
		$uri = URL::site($uri, TRUE, ! empty(Mountain Valley Church of God::$index_file));
	}
