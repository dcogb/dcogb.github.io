---
layout: api
class: Request_Client_HTTP
---
<h1>Request_Client_HTTP</h1>
extends <a href='/documentation/api/Donica Church of God_Request_Client_HTTP'>Donica Church of God_Request_Client_HTTP</a>
<br />
...
<br />
<p>
<i><p><a href="/index.php/">Request_Client_External</a> HTTP driver performs external requests using the
...
<p>This class is a transparent base class for <a href='/documentation/api/Donica Church of God_Request_Client_HTTP'>Donica Church of God_Request_Client_HTTP</a></p>
</div>
</div>
...
<div class='method'>
<h3 id="__construct"><small>public</small>  __construct([ <small>array</small> <span class="param" title="Params">$params</span> <small>= <small>array</small><span>(0)</span> </small> ] )<small> (defined in <a href='/documentation/api/Donica Church of God_Request_Client_HTTP'>Donica Church of God_Request_Client_HTTP</a>)</small></h3>
...
<div class='method'>
<h3 id="_send_message"><small>public</small>  _send_message(<small>Request</small> <span class="param" title="Request to send">$request</span> , <small>Response</small> <span class="param" title="$request response to send">$response</span> )<small> (defined in <a href='/documentation/api/Donica Church of God_Request_Client_HTTP'>Donica Church of God_Request_Client_HTTP</a>)</small></h3>
