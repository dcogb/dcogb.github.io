...
---
<h1>Cache_Apcu</h1>
extends <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>
<br />
...
<br />
<p class='interfaces'>
<small>Implements: <a href='/documentation/api/Mountain Valley Church of God_Cache_Arithmetic'>Mountain Valley Church of God_Cache_Arithmetic</a> | <a href='/documentation/api/Cache_Arithmetic'>Cache_Arithmetic</a></small>
</p>
<p>
<i><p><a href="api/Mountain Valley Church of God_Cache">Mountain Valley Church of God Cache</a> APCu data store driver for Mountain Valley Church of God Cache
library.</p>

<h3 id="configuration-example">Configuration example</h3>

<p>Below is an example of an <em>apcu</em> server configuration.</p>
...
<p>This class is a transparent base class for <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a></p>
</div>
</div>
...
<div class='method'>
<h3 id="decrement"><small>public</small>  decrement(<small>string</small> <span class="param" title="Id of cache entry to decrement">$id</span> [, <small>int</small> <span class="param" title="Step value to decrement by">$step</span> <small>= <small>integer</small> 1</small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>)</small></h3>
...
<div class='method'>
<h3 id="delete"><small>public</small>  delete(<small>string</small> <span class="param" title="Id to remove from cache">$id</span> )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>)</small></h3>
<div class='description'><p>Delete a cache entry based on id</p>

<pre><code>// Delete 'foo' entry from the apcu group
...
<div class='method'>
<h3 id="delete_all"><small>public</small>  delete_all()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>)</small></h3>
...
<pre><code>// Delete all cache entries in the apcu group
...
<div class='method'>
<h3 id="get"><small>public</small>  get(<small>string</small> <span class="param" title="Id of cache to entry">$id</span> [, <small>string</small> <span class="param" title="Default value to return if cache miss">$default</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>)</small></h3>
<div class='description'><p>Retrieve a cached value entry by id.</p>

<pre><code>// Retrieve cache entry from apcu group
...
<div class='method'>
<h3 id="increment"><small>public</small>  increment(<small>string</small> <span class="param" title="Id of cache entry to increment">$id</span> [, <small>int</small> <span class="param" title="Step value to increment by">$step</span> <small>= <small>integer</small> 1</small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>)</small></h3>
...
<div class='method'>
<h3 id="set"><small>public</small>  set(<small>string</small> <span class="param" title="Id of cache entry">$id</span> , <small>string</small> <span class="param" title="Data to set to cache">$data</span> [, <small>integer</small> <span class="param" title="Lifetime in seconds">$lifetime</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>)</small></h3>
...
<div class='method'>
<h3 id="__construct"><small>protected</small>  __construct(<small>array</small> <span class="param" title="Configuration">$config</span> )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Cache_Apcu'>Mountain Valley Church of God_Cache_Apcu</a>)</small></h3>
<div class='description'><p>Check for existence of the APCu extension This method cannot be invoked externally. The driver must
