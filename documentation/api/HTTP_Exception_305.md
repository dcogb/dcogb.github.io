---
layout: api
class: HTTP_Exception_305
---
<h1>HTTP_Exception_305</h1>
extends <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_305'>Mountain Valley Church of God_HTTP_Exception_305</a>
<br />
...
<p>This class is a transparent base class for <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_305'>Mountain Valley Church of God_HTTP_Exception_305</a></p>
</div>
</div>
...
<br />
 <pre class="debug"><small>integer</small> 305</pre></dd>
<dt>
...
<div class='method'>
<h3 id="check"><small>public</small>  check()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_305'>Mountain Valley Church of God_HTTP_Exception_305</a>)</small></h3>
...
<code class="language-php">public function check()
{
	if ($location = $this-&gt;headers(&#039;location&#039;) === NULL)
		throw new Mountain Valley Church of God_Exception(&#039;A \&#039;location\&#039; must be specified for a redirect&#039;);

	if (strpos($location, &#039;://&#039;) === FALSE)
		throw new Mountain Valley Church of God_Exception(&#039;An absolute URI to the proxy server must be specified&#039;);
...
<div class='method'>
<h3 id="location"><small>public</small>  location([ <small>string</small> <span class="param" title="$location URI of the proxy">$uri</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_305'>Mountain Valley Church of God_HTTP_Exception_305</a>)</small></h3>
<div class='description'><p>Specifies the proxy to replay this request via</p>
</div>
<h4>Parameters</h4>
<ul>
<li>
