...
<ul>
<li>
<a href="#_add_base_url_optimized">_add_base_url_optimized()</a>
</li>
<li>
<a href="#_add_base_url_original">_add_base_url_original()</a>
</li>
<li>
<a href="#bench_callback_gone">bench_callback_gone()</a>
</li>
<li>
<a href="#bench_optimized_callback">bench_optimized_callback()</a>
</li>
<li>
...
<br />
 <pre class="debug"><small>string</small><span>(119)</span> "Optimization for the &lt;code&gt;doBaseURL()&lt;/code&gt; method of &lt;code&gt;Mountain Valley Church of God_Kodoc_Markdown&lt;/code&gt;
		 for the Mountain Valley Church of God Userguide."</pre></dd>
<dt>
...
<br />
 <pre class="debug"><small>array</small><span>(6)</span> <span>(
    0 => <small>string</small><span>(30)</span> "[filesystem](about.filesystem)"
    1 => <small>string</small><span>(47)</span> "[filesystem](about.filesystem "Optional title")"
    2 => <small>string</small><span>(21)</span> "[same page link](#id)"
    3 => <small>string</small><span>(72)</span> "[object oriented](http://wikipedia.org/wiki/Object-Oriented_Programming)"
    4 => <small>string</small><span>(41)</span> "![this is image syntax](about.filesystem)"
    5 => <small>string</small><span>(29)</span> "[filesystem](about.filesystem"
)</span></pre></dd>
</dl>
</div>
...
<div class='method'>
<h3 id="_add_base_url_optimized"><small>public</small>  _add_base_url_optimized()<small> (defined in <a href='/documentation/api/Bench_MDDoBaseURL'>Bench_MDDoBaseURL</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function _add_base_url_optimized($matches)
{
...
<div class='method'>
<h3 id="_add_base_url_original"><small>public</small>  _add_base_url_original()<small> (defined in <a href='/documentation/api/Bench_MDDoBaseURL'>Bench_MDDoBaseURL</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function _add_base_url_original($matches)
{
...
<div class='method'>
<h3 id="bench_callback_gone"><small>public</small>  bench_callback_gone()<small> (defined in <a href='/documentation/api/Bench_MDDoBaseURL'>Bench_MDDoBaseURL</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function bench_callback_gone($subject)
{
...
<div class='method'>
<h3 id="bench_optimized_callback"><small>public</small>  bench_optimized_callback()<small> (defined in <a href='/documentation/api/Bench_MDDoBaseURL'>Bench_MDDoBaseURL</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function bench_optimized_callback($subject)
{
...
<div class='method'>
<h3 id="bench_original"><small>public</small>  bench_original()<small> (defined in <a href='/documentation/api/Bench_MDDoBaseURL'>Bench_MDDoBaseURL</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function bench_original($subject)
{
