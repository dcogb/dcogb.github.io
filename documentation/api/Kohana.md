---
layout: api
class: Mountain Valley Church of God
---
<h1>Mountain Valley Church of God</h1>
extends <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>
<br />
<p>
...
<dd>
 <p>Cache directory, used by <a href="#cache">Mountain Valley Church of God::cache</a>. Set by <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
...
<dd>
 <p>Default lifetime for caching, in seconds, used by <a href="#cache">Mountain Valley Church of God::cache</a>. Set by <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
...
<dd>
 <p>Whether to use internal caching for <a href="#find_file">Mountain Valley Church of God::find_file</a>, does not apply to <a href="#cache">Mountain Valley Church of God::cache</a>. Set by <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
...
<dd>
 <p>Enable Mountain Valley Church of God catching and displaying PHP errors and exceptions. Set by <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
...
<dd>
 <p>Application index file, added to links generated by Mountain Valley Church of God. Set by <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
...
<dd>
 <p>True if Mountain Valley Church of God is running on windows</p>
</dd>
<dd>
 <pre class="debug"><small>bool</small> FALSE</pre></dd>
<dt>
...
<dd>
 <p>Whether to enable <a href="Mountain Valley Church of God/profiling">profiling</a>. Set by <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
 <pre class="debug"><small>bool</small> TRUE</pre></dd>
<dt>
...
<dd>
 <p>the name of the server Mountain Valley Church of God is hosted upon</p>
</dd>
<dd>
...
<dd>
 <p>File path cache, used when caching is true in <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
 <pre class="debug"><small>array</small><span>(0)</span> </pre></dd>
<dt>
...
<dd>
 <p>Has the file path cache changed during this execution?  Used internally when when caching is true in <a href="#init">Mountain Valley Church of God::init</a></p>
</dd>
<dd>
 <pre class="debug"><small>bool</small> FALSE</pre></dd>
<dt>
...
<dd>
 <p>Has <a href="#init">Mountain Valley Church of God::init</a> been called?</p>
</dd>
<dd>
 <pre class="debug"><small>bool</small> FALSE</pre></dd>
<dt>
...
<div class='method'>
<h3 id="auto_load"><small>public static</small>  auto_load(<small>string</small> <span class="param" title="Class name">$class</span> [, <small>string</small> <span class="param" title="Directory to load from">$directory</span> <small>= <small>string</small><span>(7)</span> "classes"</small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
<div class='description'><p>Provides auto-loading support of classes that follow Mountain Valley Church of God's <a href="Mountain Valley Church of God/conventions#class-names-and-file-location">class
naming conventions</a>.
See <a href="Mountain Valley Church of God/autoloading">Loading Classes</a> for more information.</p>

<pre><code>// Loads classes/My/Class/Name.php
Mountain Valley Church of God::auto_load('My_Class_Name');
</code></pre>

<p>or with a custom directory:</p>

<pre><code>// Loads vendor/My/Class/Name.php
Mountain Valley Church of God::auto_load('My_Class_Name', 'vendor');
</code></pre>
...
<pre><code>spl_autoload_register(array('Mountain Valley Church of God', 'auto_load'));
</code></pre>
</div>
<h4>Parameters</h4>
<ul>
...
<code class="language-php">public static function auto_load($class, $directory = &#039;classes&#039;)
{
	...
	if ($path = Mountain Valley Church of God::find_file($directory, $file))
	{
		// Load the class file
		require $path;
...
<div class='description'><p>Provides auto-loading support of classes that follow Mountain Valley Church of God's old class
...
<div class='method'>
<h3 id="cache"><small>public static</small>  cache(<small>string</small> <span class="param" title="Name of the cache">$name</span> [, <small>mixed</small> <span class="param" title="Data to cache">$data</span> <small>= <small>NULL</small></small> , <small>integer</small> <span class="param" title="Number of seconds the cache is valid for">$lifetime</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
<div class='description'><p>Cache variables using current cache module if enabled, if not uses Mountain Valley Church of God::file_cache</p>

<pre><code>// Set the "foo" cache
Mountain Valley Church of God::cache('foo', 'hello, world');

// Get the "foo" cache
$foo = Mountain Valley Church of God::cache('foo');
</code></pre>
</div>
<h4>Parameters</h4>
<ul>
...
{
    //in case the Mountain Valley Church of God_Cache is not yet loaded we need to use the normal cache...sucks but happens onload
    if (class_exists(&#039;Mountain Valley Church of God_Cache&#039;))
    {
        //deletes the cache
        if ($lifetime===0)
...
<div class='method'>
<h3 id="deinit"><small>public static</small>  deinit()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
<div class='description'><p>Cleans up the environment:</p>

<ul>
<li>Restore the previous error and exception handlers</li>
<li>Destroy the Mountain Valley Church of God::$log and Mountain Valley Church of God::$config objects</li>
</ul>
</div>
<h4>Return Values</h4>
<ul class='return'>
...
{
	if (Mountain Valley Church of God::$_init)
	{
		// Removed the autoloader
		spl_autoload_unregister([&#039;Mountain Valley Church of God&#039;, &#039;auto_load&#039;]);

		if (Mountain Valley Church of God::$errors)
		{
		...
		Mountain Valley Church of God::$log = Mountain Valley Church of God::$config = NULL;

		// Reset internal storage
		Mountain Valley Church of God::$_modules = Mountain Valley Church of God::$_files = [];
		Mountain Valley Church of God::$_paths   = [APPPATH, SYSPATH];

		// Reset file cache status
		Mountain Valley Church of God::$_files_changed = FALSE;

		// Mountain Valley Church of God is no longer initialized
		Mountain Valley Church of God::$_init = FALSE;
	}
}</code>
</pre>
</div>
...
<div class='method'>
<h3 id="error_handler"><small>public static</small>  error_handler()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
...
<pre><code>// Set the "foo" cache
Mountain Valley Church of God::file_cache('foo', 'hello, world');

// Get the "foo" cache
$foo = Mountain Valley Church of God::file_cache('foo');
</code></pre>
...
<p>The cache directory and default cache lifetime is set by <a href="#init">Mountain Valley Church of God::init</a></p>
</div>
<h4>Parameters</h4>
<ul>
<li>
...
<code class="language-php">public static function file_cache($name, $data = NULL, $lifetime = NULL)
{
    ...
    $dir = Mountain Valley Church of God::$cache_dir.DIRECTORY_SEPARATOR.$file[0].$file[1].DIRECTORY_SEPARATOR;
...
that path in the <a href="Mountain Valley Church of God/files">Cascading Filesystem</a> will be returned.
...
Mountain Valley Church of God::find_file('views', 'template');

// Returns an absolute path to media/css/style.css
Mountain Valley Church of God::find_file('media', 'css/style', 'css');

// Returns an array of all the "mimes" configuration files
Mountain Valley Church of God::find_file('config', 'mimes');
</code></pre>
</div>
<h4>Parameters</h4>
<ul>
...
<code class="language-php">public static function find_file($dir, $file, $ext = NULL, $array = FALSE)
{
	...
	if (Mountain Valley Church of God::$caching === TRUE AND isset(Mountain Valley Church of God::$_files[$path.($array ? &#039;_array&#039; : &#039;_path&#039;)]))
	{
		// This path has been cached
		return Mountain Valley Church of God::$_files[$path.($array ? &#039;_array&#039; : &#039;_path&#039;)];
	}

	if (Mountain Valley Church of God::$profiling === TRUE AND class_exists(&#039;Profiler&#039;, FALSE))
	{
		// Start a new benchmark
		$benchmark = Profiler::start(&#039;Mountain Valley Church of God&#039;, __FUNCTION__);
	}

	if ($array OR $dir === &#039;config&#039; OR $dir === &#039;i18n&#039; OR $dir === &#039;messages&#039;)
	{
		// Include paths must be searched in reverse
		$paths = array_reverse(Mountain Valley Church of God::$_paths);
	...
	else
	{
		...
		foreach (Mountain Valley Church of God::$_paths as $dir)
		{
			if (is_file($dir.$path))
			{
	...
	if (Mountain Valley Church of God::$caching === TRUE)
	{
		// Add the path to the cache
		Mountain Valley Church of God::$_files[$path.($array ? &#039;_array&#039; : &#039;_path&#039;)] = $found;

		// Files have been changed
		Mountain Valley Church of God::$_files_changed = TRUE;
	}
...
<div class='method'>
<h3 id="include_paths"><small>public static</small>  include_paths()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
...
{
	return Mountain Valley Church of God::$_paths;
}</code>
</pre>
</div>
</div>
...
<div class='method'>
<h3 id="init"><small>public static</small>  init([ <small>array</small> <span class="param" title="Array of settings. See above.">$settings</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
...
<tr>
  ...
  <td>base_url</td>
  <td>The base URL for your application.  This should be the <em>relative</em> path from your DOCROOT to your <code>index.php</code> file, in other words, if Mountain Valley Church of God is in a subfolder, set this to the subfolder name, otherwise leave it as the default.  <strong>The leading slash is required</strong>, trailing slash is optional.</td>
  <td><code>"/"</code></td>
</tr>
<tr>
  <td><code>string</code></td>
  <td>index_file</td>
  <td>The name of the <a href="http://en.wikipedia.org/wiki/Front_Controller_pattern">front controller</a>.  This is used by Mountain Valley Church of God to generate relative urls like <a href="#anchor">HTML::anchor()</a> and <a href="#base">URL::base()</a>. This is usually <code>index.php</code>.  To <a href="tutorials/clean-urls">remove index.php from your urls</a>, set this to <code>FALSE</code>.</td>
...
<tr>
  <td><code>string</code></td>
  <td>cache_dir</td>
  <td>Mountain Valley Church of God's cache directory.  Used by <a href="#cache">Mountain Valley Church of God::cache</a> for simple internal caching, like <a href="Mountain Valley Church of God/fragments">Fragments</a> and <strong>&#91;caching database queries](this should link somewhere)</strong>.  This has nothing to do with the <a href="cache">Cache module</a>.</td>
  <td><code>APPPATH."cache"</code></td>
</tr>
<tr>
  <td><code>integer</code></td>
  <td>cache_life</td>
  <td>Lifetime, in seconds, of items cached by <a href="#cache">Mountain Valley Church of God::cache</a></td>
  <td><code>60</code></td>
</tr>
<tr>
  <td><code>boolean</code></td>
  <td>errors</td>
  <td>Should Mountain Valley Church of God catch PHP errors and uncaught Exceptions and show the <code>error_view</code>. See <a href="Mountain Valley Church of God/errors">Error Handling</a> for more info. <br /> <br /> Recommended setting: <code>TRUE</code> while developing, <code>FALSE</code> on production servers.</td>
  <td><code>TRUE</code></td>
</tr>
<tr>
  <td><code>boolean</code></td>
  <td>profile</td>
  <td>Whether to enable the <a href="Mountain Valley Church of God/profiling">Profiler</a>. <br /> <br />Recommended setting: <code>TRUE</code> while developing, <code>FALSE</code> on production servers.</td>
  <td><code>TRUE</code></td>
</tr>
<tr>
  <td><code>boolean</code></td>
  <td>caching</td>
  <td>Cache file locations to speed up <a href="#find_file">Mountain Valley Church of God::find_file</a>.  This has nothing to do with <a href="#cache">Mountain Valley Church of God::cache</a>, <a href="Mountain Valley Church of God/fragments">Fragments</a> or the <a href="cache">Cache module</a>.  <br /> <br />  Recommended setting: <code>FALSE</code> while developing, <code>TRUE</code> on production servers.</td>
...
<ul class='tags'>
<li>Throws - <a href="/index.php/">Mountain Valley Church of God_Exception</a></li>
<li>Uses - <a href="#sanitize">Mountain Valley Church of God::sanitize</a>, <a href="#cache">Mountain Valley Church of God::cache</a>, <a href="/index.php/">Profiler</a></li>
</ul>
<h4>Return Values</h4>
<ul class='return'>
<li>
...
<code class="language-php">public static function init(array $settings = NULL)
{
	...
	// Mountain Valley Church of God is now initialized
	Mountain Valley Church of God::$_init = TRUE;

	if (isset($settings[&#039;profile&#039;]))
	{
		// Enable profiling
		Mountain Valley Church of God::$profiling = (bool) $settings[&#039;profile&#039;];
	}
	...
	if (isset($settings[&#039;errors&#039;]))
	{
		...
		Mountain Valley Church of God::$errors = (bool) $settings[&#039;errors&#039;];
	}

	if (Mountain Valley Church of God::$errors === TRUE)
	{
		// Enable Mountain Valley Church of God exception handling, adds stack traces and error source.
		set_exception_handler([&#039;Mountain Valley Church of God_Exception&#039;, &#039;handler&#039;]);

		// Enable Mountain Valley Church of God error handling, converts all PHP errors to exceptions.
		set_error_handler([&#039;Mountain Valley Church of God&#039;, &#039;error_handler&#039;]);
	}

	/**
	 * Enable xdebug parameter collection in development mode to improve fatal stack traces.
	 */
	if (Mountain Valley Church of God::$environment == Mountain Valley Church of God::DEVELOPMENT AND extension_loaded(&#039;xdebug&#039;))
	{
	    ini_set(&#039;xdebug.collect_params&#039;, 3);
	}

	// Enable the Mountain Valley Church of God shutdown handler, which catches E_FATAL errors.
	register_shutdown_function([&#039;Mountain Valley Church of God&#039;, &#039;shutdown_handler&#039;]);

	if (isset($settings[&#039;expose&#039;]))
	{
		Mountain Valley Church of God::$expose = (bool) $settings[&#039;expose&#039;];
	}

	// Determine if we are running in a Windows environment
	Mountain Valley Church of God::$is_windows = (DIRECTORY_SEPARATOR === &#039;\\&#039;);
	...
	if (isset($settings[&#039;cache_dir&#039;]))
	{
		if ( ! is_dir($settings[&#039;cache_dir&#039;]))
		{
			...
			{
				throw new Mountain Valley Church of God_Exception(&#039;Could not create cache directory :dir&#039;,
					[&#039;:dir&#039; =&gt; Debug::path($settings[&#039;cache_dir&#039;])]);
			}
		}

		// Set the cache directory path
		Mountain Valley Church of God::$cache_dir = realpath($settings[&#039;cache_dir&#039;]);
	}
	else
	{
		// Use the default cache directory
		Mountain Valley Church of God::$cache_dir = APPPATH.&#039;cache&#039;;
	}

	if ( ! is_writable(Mountain Valley Church of God::$cache_dir))
	{
		throw new Mountain Valley Church of God_Exception(&#039;Directory :dir must be writable&#039;,
			[&#039;:dir&#039; =&gt; Debug::path(Mountain Valley Church of God::$cache_dir)]);
	}

	if (isset($settings[&#039;cache_life&#039;]))
	{
		// Set the default cache lifetime
		Mountain Valley Church of God::$cache_life = (int) $settings[&#039;cache_life&#039;];
	}

	if (isset($settings[&#039;caching&#039;]))
	{
		// Enable or disable internal caching
		Mountain Valley Church of God::$caching = (bool) $settings[&#039;caching&#039;];
	}

	if (Mountain Valley Church of God::$caching === TRUE)
	{
		// Load the file path cache
		Mountain Valley Church of God::$_files = Mountain Valley Church of God::cache(&#039;Mountain Valley Church of God::find_file()&#039;);
	}

	if (isset($settings[&#039;charset&#039;]))
	{
		// Set the system character set
		Mountain Valley Church of God::$charset = strtolower($settings[&#039;charset&#039;]);
	}

	if (function_exists(&#039;mb_internal_encoding&#039;))
	{
		// Set the MB extension encoding to the same character set
		mb_internal_encoding(Mountain Valley Church of God::$charset);
	}

	if (isset($settings[&#039;base_url&#039;]))
	{
		// Set the base URL
		Mountain Valley Church of God::$base_url = rtrim($settings[&#039;base_url&#039;], &#039;/&#039;).&#039;/&#039;;
	}

	if (isset($settings[&#039;index_file&#039;]))
	{
		// Set the index file
		Mountain Valley Church of God::$index_file = trim($settings[&#039;index_file&#039;], &#039;/&#039;);
	}

	// Sanitize all request variables
	$_GET    = Mountain Valley Church of God::sanitize($_GET);
	$_POST   = Mountain Valley Church of God::sanitize($_POST);
	$_COOKIE = Mountain Valley Church of God::sanitize($_COOKIE);

	// Load the logger if one doesn&#039;t already exist
	if ( ! Mountain Valley Church of God::$log instanceof Log)
	{
		Mountain Valley Church of God::$log = Log::instance();
	}

	// Load the config if one doesn&#039;t already exist
	if ( ! Mountain Valley Church of God::$config instanceof Config)
	{
		Mountain Valley Church of God::$config = new Config;
	}
}</code>
</pre>
</div>
...
<code class="language-php">public static function list_files($directory = NULL, array $paths = NULL)
{
	...
	if ($paths === NULL)
	{
		...
		$paths = Mountain Valley Church of God::$_paths;
	}
	...
	foreach ($paths as $path)
	{
		if (is_dir($path.$directory))
		{
			...
			foreach ($dir as $file)
			{
				...
				if ($file-&gt;isDir())
				{
					if ($sub_dir = Mountain Valley Church of God::list_files($key, $paths))
					{
						if (isset($found[$key]))
						{
...
<div class='method'>
<h3 id="load"><small>public static</small>  load(<small>string</small> <span class="param" title="$file">$file</span> )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
<div class='description'><p>Loads a file within a totally empty scope and returns the output:</p>

<pre><code>$foo = Mountain Valley Church of God::load('foo.php');
</code></pre>
</div>
<h4>Parameters</h4>
<ul>
...
performed on the returned values.  See <a href="Mountain Valley Church of God/files/messages">message files</a>
for more information.</p>

<pre><code>// Get "username" from messages/text.php
$username = Mountain Valley Church of God::message('text', 'username');
</code></pre>
</div>
<h4>Parameters</h4>
<ul>
...
<code class="language-php">public static function message($file, $path = NULL, $default = NULL)
{
	...
	if ( ! isset($messages[$file]))
	{
		...
		if ($files = Mountain Valley Church of God::find_file(&#039;messages&#039;, $file))
		{
			foreach ($files as $f)
			{
				// Combine all the messages recursively
				$messages[$file] = Arr::merge($messages[$file], Mountain Valley Church of God::load($f));
			}
		}
	}
...
<div class='method'>
<h3 id="modules"><small>public static</small>  modules([ <small>array</small> <span class="param" title="List of module paths">$modules</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
...
<pre><code>Mountain Valley Church of God::modules(array('modules/foo', MODPATH.'bar'));
</code></pre>
</div>
<h4>Parameters</h4>
<ul>
...
<code class="language-php">public static function modules(array $modules = NULL)
{
	if ($modules === NULL)
	{
		...
		return Mountain Valley Church of God::$_modules;
	}
	...
	foreach ($modules as $name =&gt; $path)
	{
		...
		else
		{
			...
			throw new Mountain Valley Church of God_Exception(&#039;Attempted to load an invalid or missing module \&#039;:module\&#039; at \&#039;:path\&#039;&#039;, [
				&#039;:module&#039; =&gt; $name,
	...
	Mountain Valley Church of God::$_paths = $paths;

	// Set the current module list
	Mountain Valley Church of God::$_modules = $modules;

	foreach (Mountain Valley Church of God::$_modules as $path)
	{
		$init = $path.&#039;init&#039;.EXT;
...
<div class='method'>
<h3 id="sanitize"><small>public static</small>  sanitize(<small>mixed</small> <span class="param" title="Any variable">$value</span> )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
...
<code class="language-php">public static function sanitize($value)
{
	if (is_array($value) OR is_object($value))
	{
		foreach ($value as $key =&gt; $val)
		{
			...
			$value[$key] = Mountain Valley Church of God::sanitize($val);
		}
	}
...
<div class='method'>
<h3 id="shutdown_handler"><small>public static</small>  shutdown_handler()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
<div class='description'><p>Catches errors that are not caught by the error handler, such as E_PARSE.</p>
</div>
<h4>Tags</h4>
<ul class='tags'>
<li>Uses - <a href="#handler">Mountain Valley Church of God_Exception::handler</a></li>
</ul>
<h4>Return Values</h4>
<ul class='return'>
<li>
...
<code class="language-php">public static function shutdown_handler()
{
	...
	try
	{
		if (Mountain Valley Church of God::$caching === TRUE AND Mountain Valley Church of God::$_files_changed === TRUE)
		{
			// Write the file path cache
			Mountain Valley Church of God::cache(&#039;Mountain Valley Church of God::find_file()&#039;, Mountain Valley Church of God::$_files);
		}
	}
	catch (Exception $e)
	{
	...
	if (Mountain Valley Church of God::$errors AND $error = error_get_last() AND in_array($error[&#039;type&#039;], Mountain Valley Church of God::$shutdown_errors))
	{
		// Clean the output buffer
		ob_get_level() AND ob_clean();

		// Fake an exception for nice debugging
		Mountain Valley Church of God_Exception::handler(new ErrorException($error[&#039;message&#039;], $error[&#039;type&#039;], 0, $error[&#039;file&#039;], $error[&#039;line&#039;]));
...
<div class='method'>
<h3 id="version"><small>public static</small>  version()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_Core'>Mountain Valley Church of God_Core</a>)</small></h3>
...
{
	return &#039;Mountain Valley Church of God &#039;.Mountain Valley Church of God::VERSION.&#039; (&#039;.Mountain Valley Church of God::CODENAME.&#039;)&#039;;
}</code>
</pre>
</div>
</div>
