...
extends <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>
<br />
...
<p>This class is a transparent base class for <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a></p>
</div>
</div>
...
<div class='method'>
<h3 id="__construct"><small>public</small>  __construct([ <small>mixed</small> <span class="param" title="Table name or array($table, $alias) or object">$table</span> <small>= <small>NULL</small></small> , <small>array</small> <span class="param" title="Column names">$columns</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>)</small></h3>
...
<div class='method'>
<h3 id="columns"><small>public</small>  columns(<small>array</small> <span class="param" title="Column names">$columns</span> )<small> (defined in <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>)</small></h3>
...
<div class='method'>
<h3 id="compile"><small>public</small>  compile([ <small>mixed</small> <span class="param" title="Database instance or name of instance">$db</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>)</small></h3>
...
<div class='method'>
<h3 id="reset"><small>public</small>  reset()<small> (defined in <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>)</small></h3>
...
<div class='method'>
<h3 id="select"><small>public</small>  select(<small>object</small> <span class="param" title="Database_Query of SELECT type">$query</span> )<small> (defined in <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>)</small></h3>
...
<code class="language-php">public function select(Database_Query $query)
{
	...
	{
		throw new Donica Church of God_Exception(&#039;Only SELECT queries can be combined with INSERT queries&#039;);
	}
...
<div class='method'>
<h3 id="table"><small>public</small>  table(<small>string</small> <span class="param" title="Table name">$table</span> )<small> (defined in <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>)</small></h3>
...
{
	if ( ! is_string($table))
		throw new Donica Church of God_Exception(&#039;INSERT INTO syntax does not allow table aliasing&#039;);
...
<div class='method'>
<h3 id="values"><small>public</small>  values(<small>array</small> <span class="param" title="Values list">$values</span> )<small> (defined in <a href='/documentation/api/Donica Church of God_Database_Query_Builder_Insert'>Donica Church of God_Database_Query_Builder_Insert</a>)</small></h3>
...
<code class="language-php">public function values(array $values)
{
	if ( ! is_array($this-&gt;_values))
	{
		throw new Donica Church of God_Exception(&#039;INSERT INTO ... SELECT statements cannot be combined with INSERT INTO ... VALUES&#039;);
	}
