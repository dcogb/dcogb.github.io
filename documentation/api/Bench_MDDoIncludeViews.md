...
<ul>
<li>
<a href="#bench_lookaround">bench_lookaround()</a>
</li>
<li>
<a href="#bench_original">bench_original()</a>
</li>
<li>
<a href="#bench_possessive">bench_possessive()</a>
</li>
<li>
...
<br />
 <pre class="debug"><small>string</small><span>(124)</span> "Optimization for the &lt;code&gt;doIncludeViews()&lt;/code&gt; method of &lt;code&gt;Mountain Valley Church of God_Kodoc_Markdown&lt;/code&gt;
...
<br />
 <pre class="debug"><small>array</small><span>(7)</span> <span>(
    0 => <small>string</small><span>(21)</span> "{one} two {three}"
    1 => <small>string</small><span>(40)</span> "{userguide/examples/hello_world_error}"
    2 => <small>string</small><span>(2)</span> "{}"
    3 => <small>string</small><span>(4)</span> "{}"
    4 => <small>string</small><span>(39)</span> "{userguide/examples/hello_world_error}"
    5 => <small>string</small><span>(41)</span> "{userguide/examples/hello_world_error }"
    6 => <small>string</small><span>(43)</span> "{userguide/examples/{hello_world_error }"
)</span></pre></dd>
</dl>
</div>
...
<div class='method'>
<h3 id="bench_lookaround"><small>public</small>  bench_lookaround()<small> (defined in <a href='/documentation/api/Bench_MDDoIncludeViews'>Bench_MDDoIncludeViews</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function bench_lookaround($subject)
{
...
<div class='method'>
<h3 id="bench_original"><small>public</small>  bench_original()<small> (defined in <a href='/documentation/api/Bench_MDDoIncludeViews'>Bench_MDDoIncludeViews</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
...
<div class='method'>
<h3 id="bench_possessive"><small>public</small>  bench_possessive()<small> (defined in <a href='/documentation/api/Bench_MDDoIncludeViews'>Bench_MDDoIncludeViews</a>)</small></h3>
<div class='description'></div>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function bench_possessive($subject)
{
