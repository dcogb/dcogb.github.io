---
layout: api
class: HTTP_Exception_401
---
<h1>HTTP_Exception_401</h1>
extends <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_401'>Mountain Valley Church of God_HTTP_Exception_401</a>
<br />
extends <a href='/documentation/api/HTTP_Exception_Expected'>HTTP_Exception_Expected</a>
<br />
extends <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_Expected'>Mountain Valley Church of God_HTTP_Exception_Expected</a>
<br />
...
Mountain Valley Church of God error page should never be shown.</p>
...
<p>This class is a transparent base class for <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_401'>Mountain Valley Church of God_HTTP_Exception_401</a></p>
</div>
</div>
...
<br />
 <pre class="debug"><small>integer</small> 401</pre></dd>
<dt>
...
<div class='method'>
<h3 id="authenticate"><small>public</small>  authenticate([ <small>string</small> <span class="param" title="WWW-Authenticate challenge (eg `Basic realm="Control Panel"`)">$challenge</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_401'>Mountain Valley Church of God_HTTP_Exception_401</a>)</small></h3>
<div class='description'><p>Specifies the WWW-Authenticate challenge.</p>
</div>
<h4>Parameters</h4>
<ul>
<li>
 <span class="blue">string </span><strong> $challenge</strong> <small> = <small>NULL</small></small> - WWW-Authenticate challenge (eg `Basic realm="Control Panel"`)</li>
</ul>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function authenticate($challenge = NULL)
{
	if ($challenge === NULL)
...
<div class='method'>
<h3 id="check"><small>public</small>  check()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_401'>Mountain Valley Church of God_HTTP_Exception_401</a>)</small></h3>
...
<code class="language-php">public function check()
{
	if ($this-&gt;headers(&#039;www-authenticate&#039;) === NULL)
		throw new Mountain Valley Church of God_Exception(&#039;A \&#039;www-authenticate\&#039; header must be specified for a HTTP 401 Unauthorized&#039;);
...
<div class='method'>
<h3 id="__construct"><small>public</small>  __construct([ <small>string</small> <span class="param" title="Status message, custom content to display with error">$message</span> <small>= <small>NULL</small></small> , <small>array</small> <span class="param" title="Translation variables">$variables</span> <small>= <small>NULL</small></small> , $previous <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_Expected'>Mountain Valley Church of God_HTTP_Exception_Expected</a>)</small></h3>
...
<div class='method'>
<h3 id="get_response"><small>public</small>  get_response()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_Expected'>Mountain Valley Church of God_HTTP_Exception_Expected</a>)</small></h3>
...
<div class='method'>
<h3 id="headers"><small>public</small>  headers([ <small>mixed</small> <span class="param" title="$key">$key</span> <small>= <small>NULL</small></small> , <small>string</small> <span class="param" title="$value">$value</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_Expected'>Mountain Valley Church of God_HTTP_Exception_Expected</a>)</small></h3>
