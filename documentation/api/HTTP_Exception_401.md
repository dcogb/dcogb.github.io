...
extends <a href='/documentation/api/Kohana_HTTP_Exception_401'>Kohana_HTTP_Exception_401</a>
<br />
...
<p>This class is a transparent base class for <a href='/documentation/api/Kohana_HTTP_Exception_401'>Kohana_HTTP_Exception_401</a></p>
</div>
</div>
...
<div class='method'>
<h3 id="authenticate"><small>public</small>  authenticate([ <small>string</small> <span class="param" title="WWW-Authenticate challenge (eg `Basic realm="Control Panel"`)">$challenge</span> <small>= <small>NULL</small></small> ] )<small> (defined in <a href='/documentation/api/Kohana_HTTP_Exception_401'>Kohana_HTTP_Exception_401</a>)</small></h3>
...
<div class='method'>
<h3 id="check"><small>public</small>  check()<small> (defined in <a href='/documentation/api/Kohana_HTTP_Exception_401'>Kohana_HTTP_Exception_401</a>)</small></h3>
