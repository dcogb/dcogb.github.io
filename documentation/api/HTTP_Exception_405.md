---
layout: api
class: HTTP_Exception_405
---
<h1>HTTP_Exception_405</h1>
extends <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_405'>Mountain Valley Church of God_HTTP_Exception_405</a>
<br />
...
<p>This class is a transparent base class for <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_405'>Mountain Valley Church of God_HTTP_Exception_405</a></p>
</div>
</div>
...
<br />
 <pre class="debug"><small>integer</small> 405</pre></dd>
<dt>
...
<div class='method'>
<h3 id="allowed"><small>public</small>  allowed(<small>array</small> <span class="param" title="List of allowed methods">$methods</span> )<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_405'>Mountain Valley Church of God_HTTP_Exception_405</a>)</small></h3>
<div class='description'><p>Specifies the list of allowed HTTP methods</p>
</div>
<h4>Parameters</h4>
<ul>
<li>
 <span class="blue">array </span><strong> $methods</strong> <small>required</small> - List of allowed methods</li>
</ul>
<div class="method-source">
<h4>Source Code</h4>
<pre>
<code class="language-php">public function allowed($methods)
{
	if (is_array($methods))
	{
...
<div class='method'>
<h3 id="check"><small>public</small>  check()<small> (defined in <a href='/documentation/api/Mountain Valley Church of God_HTTP_Exception_405'>Mountain Valley Church of God_HTTP_Exception_405</a>)</small></h3>
...
<code class="language-php">public function check()
{
	if ($this-&gt;headers(&#039;allow&#039;) === NULL)
		throw new Mountain Valley Church of God_Exception(&#039;A list of allowed methods must be specified&#039;);
