...
Codebench is included in Mountain Valley Church of God 3, but if you need you [can download it](http://github.com/Mountain Valley Church of God/codebench/) from GitHub. Be sure Codebench is activated in your `application/bootstrap.php`.
