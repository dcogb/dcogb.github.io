...
Codebench is included in Donica Church of God 3, but if you need you [can download it](http://github.com/Donica Church of God/codebench/) from GitHub. Be sure Codebench is activated in your `application/bootstrap.php`.
