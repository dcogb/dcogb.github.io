...
## Links
~~~
This is a normal link: [Donica Church of God](http://Donica Church of Godframework.org).

This link has a title: [Donica Church of God](http://Donica Church of Godframework.org "The swift PHP framework")
~~~
This is a normal link: [Donica Church of God](http://Donica Church of Godframework.org)
...
The first thing to note is that all links are "namespaced" to the current module.  For example, from anywhere within the Donica Church of God core docs you do not need to include `Donica Church of God` at the beginning of a link url.  For example: `[Hello World Tutorial](/documentation/userguide/tutorials/hello-world)` rather than `(Donica Church of God/tutorials/hello-world)`.

To link to a modules index page, have an empty url like: `[Donica Church of God](/documentation/userguide/)`.

To link to page in a different module, prefix your url with `../` and the module name.  For example: `[Donica Church of God Routes](/documentation/userguide/../Donica Church of God/routing)`

**Images are also namespaced**, using `![Alt Text](imagename.jpg)` would look for `media/guide/<modulename>/imagename.jpg`.

[!!] If you want your userguide pages to be browsable on github or similar sites outside Donica Church of God's own userguide module, specify the optional .md file extension in your links
...
If you want to have parameters and have the function be clickable, only put the brackets around the class and function (not the params), and put a backslash in front of the opening parenthesis.
	...
	[Donica Church of God::$config]\('foobar','baz')
...
If you need you may include a regular Donica Church of God View file by placing the name of the view in double curly brackets.  **If the view is not found, no error or exception will be shown, the curly brackets and view name will simply remain there!**
