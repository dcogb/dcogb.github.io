...
title: Cache
---
# About Donica Church of God Cache

[Donica Church of God_Cache] provides a common interface to a variety of caching engines. [Cache_Tagging] is
...
## What the Donica Church of God Cache module does (and does not do)
...
_Donica Church of God Cache_ does not provide HTTP style caching for clients (web browsers) and/or proxies (_Varnish_, _Squid_). There are other Donica Church of God modules that provide this functionality.

## Choosing a cache provider

Getting and setting values to cache is very simple when using the _Donica Church of God Cache_ interface. The hardest choice is choosing which cache engine to use. When choosing a caching engine, the following criteria must be considered:
...
It is possible to have hybrid cache solutions that use a combination of the engines above in different contexts. This is supported with _Donica Church of God Cache_ as well

## Minimum requirements

 *  Donica Church of God 3.0.4
